...
- Code: `src/superkv/attention.py` (patched Qwen3.5 attention: normal, max-read, query steering, residual hook), `src/superkv/prompts.py`, `scripts/0N_*.py`, `nbs/demo.py`.
